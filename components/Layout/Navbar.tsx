        ...
        <div className="hidden md:flex md:items-center md:w-auto w-full" id="menu">
            <nav>
                <ul className="md:flex items-center text-center justify-between text-lg text-gray-900 dark:text-gray-400 pt-4 md:pt-0">
                    ...
                    <li>
                        <a href="#experience" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover-text-colored hover-border-colored">Experience</a>
                    </li>
                    <li>
                        <a href="#projects" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover-text-colored hover-border-colored">Projects</a>
                    </li>
                    <li>
                        <a href="#contact" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover-text-colored hover-border-colored">Contact</a>
                    </li>
                    <ul>
