...
export const Card: React.FC<CardProps> = ({ className, heading, description, technologies, links, bgImageSrc }) => {
  return <div className={"relative flex flex-col-reverse justify-center w-full md:h-96 " + className}>
